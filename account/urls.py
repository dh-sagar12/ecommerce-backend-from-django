...
from account.views.authenticationView import GetUserData, UserLoginView, UserCreationView, GetGenderData, UserShippingDetailView
...
urlpatterns = [
    ...
    path('shipping-detail/', UserShippingDetailView.as_view(), name='shipping_details'),
